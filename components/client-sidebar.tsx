...
import { Calendar, Home, Activity, User, Settings, Zap, LogOut, Utensils, Timer } from "lucide-react"
...
const clientItems = [
    ...
    {
        title: "My Workouts",
        url: "/client-dashboard/workouts",
        icon: Activity,
    },
    {
        title: "Nutrition Plan",
        url: "/client-dashboard/nutrition",
        icon: Utensils,
    },
    {
        title: "Schedule",
        url: "/client-dashboard/schedule",
        icon: Calendar,
    },
    {
        title: "Progress",
        url: "/client-dashboard/progress",
        icon: Timer,
    },
    {
        title: "Profile",
...
export function ClientSidebar() {
    ...
    const handleLogout = () => {
        toast.info("Signing Out", { description: "See you next session." })
        setTimeout(() => {
            router.push("/login")
        }, 1000)
    }
                    ...
                    >
                        <div className="relative">
                            <Avatar className="h-10 w-10 border-2 border-[#E11D48]/20 group-hover:border-[#E11D48]/50 transition-colors">
                                ...
                                <AvatarFallback className="bg-neutral-800 text-white">CL</AvatarFallback>
                            </Avatar>
                        ...
                        <div className="flex flex-col group-data-[collapsible=icon]:hidden transition-all">
                            <span className="text-sm font-bold text-white group-hover:text-[#E11D48] transition-colors">Client User</span>
                            <span className="text-[10px] uppercase font-bold tracking-wider text-neutral-500">Member Access</span>
                        </div>
